...
RSpec.describe 'Debugging Exercises' do
  ...
  describe 'correct_isogram' do
    it 'Returns true since "Odin" is an isogram' do
      expect(correct_isogram?("Odin")).to eq "Odin is an isogram"
    end
  
    it 'Returns false since "hello" is not an isogram' do
      expect(correct_isogram?("hello")).to eq "hello is not an isogram"
    end
  end
