...
my_favorites = { color: 'blue', number: 65 } #=> ["blue"]
my_favorites = { color: ['orange', 'green'], number: { lucky: 7 } } #=> ["orange", "green"]
my_favorites = { number: 21, movie: 'Avengers: Endgame' } #=> nil
p favorite_color(my_favorites) 
